...
MENU_DATA = {
    ...
    "주류": ["진토닉", "마티니", "네그로니", "김렛", "톰 콜린스", "싱가포르 슬링", "하이볼", "올드 패션드", "맨해튼", "위스키 사워", "민트 줄렙", "갓파더", "모히토", "다이키리", "피냐 콜라다", "쿠바 리브레", "마이 타이", "모스크바 뮬", "코스모폴리탄", "블랙 러시안", "화이트 러시안", "에스프레소 마티니", "섹스 온 더 비치", "블러디 메리", "마가리타", "데킬라 선라이즈", "팔로마", "사이드카", "미도리 사워", "피치 크러쉬"],
    "기타": "ETC_MODE"
}
